...
func (b *Bot) newStoreFuncForRefresh(teamID string) func(accessToken, refreshToken string) error {
	return func(accessToken, refreshToken string) error {
		return b.createOrUpdateSlackCredential(teamID, accessToken, refreshToken)
	}
}

func (b *Bot) createOrUpdateSlackCredential(teamID, accessToken, refreshToken string) error {
